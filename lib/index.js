...
var Config = Schema.object({
  ...
  sampleRate: Schema.union([
    Schema.const(16e3).description("16000 Hz"),
    Schema.const(24e3).description("24000 Hz"),
    Schema.const(32e3).description("32000 Hz"),
    Schema.const(44100).description("44100 Hz\uFF08\u63A8\u8350\uFF09")
  ]).default(44100).description("\u91C7\u6837\u7387"),
  bitrate: Schema.union([
    Schema.const(32e3).description("32 kbps"),
    Schema.const(64e3).description("64 kbps"),
    Schema.const(128e3).description("128 kbps"),
    Schema.const(256e3).description("256 kbps\uFF08\u63A8\u8350\uFF09")
